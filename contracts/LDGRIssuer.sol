...
contract LDGRIssuer is Owned, TransferAgentControlled {
    ...
    constructor(
        ...
        public
        Owned(_initialOwner)
        TransferAgentControlled(_initialTransferAgent)
    {
        name = _name;
    ...
    function setPhysicalAddressOfOperation(
        string _newPhysicalAddressOfOperation
    ) public onlyOwner {
        _setPhysicalAddressOfOperation(_newPhysicalAddressOfOperation);
    }

    function _setPhysicalAddressOfOperation(
        string _newPhysicalAddressOfOperation
    ) internal {
        emit PhysicalAddressOfOperationUpdated(
    ...
    function createSecurity(string _name, string _symbol)
        public
        onlyTransferAgent
        returns (address)
    {
    ...
    function _createSecurity(string _name, string _symbol)
        internal
        returns (address)
    {
